...
class KodinerdsPiers(machine: Shield, context: Context) : Kodi(machine, context) {
    override val pkgname = "net.kodinerds.maven.kodi22"
    override val heading = "Kodinerds Piers"
    override val release = "piers"
    ...
    override suspend fun runGather(): File? = withContext(Dispatchers.IO) {
        ...
        val pattern = Regex("aktuelle.*download=(.*master.apk)(?=\")")
